        ...
        {isOpen && (
          ...
          >
            <Card className="flex flex-col w-96 h-full border-primary/30 neon-border bg-card/90 backdrop-blur-sm shadow-xl bg-gradient-to-r from-gray-100 to-white border ">
              {/* Chat header */}
              <div className="flex items-center justify-between py-4 px-3 border-b border-green-500 ">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {products && products.length > 0 ? (
                              products.map((product) => (
                                <div
                                  key={product._id}
                                  className="bg-[#0f1219] backdrop-blur-sm p-3 rounded-md border border-primary/20 shadow-md hover:shadow-primary/20 transition-all duration-300 shadow-[0_2px_8px_rgba(0,255,0,0.1)]"
                                >
                                  {product.image_url && (
                                    <img
              ...
              {/* Chat input */}
              <div className="p-5 border-t border-primary/30 text-black ">
                <form onSubmit={handleSubmit} className="flex space-x-2">
                  <Input
                    ...
                    className=" bg-gray-300 border border-green-200 border-primary/30 text-white placeholder-gray-400 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 shadow-[0_2px_4px_rgba(0,255,0,0.1)]"
                    disabled={isProcessing}
                  />
                  <Button
                    type="submit"
                    disabled={!inputValue.trim() || isProcessing}
                    className=" bg-gradient-to-r from-green-400 to-blue-400 text-white font-bold text-2xl hover:bg-primary/90"
                  >
                    {isProcessing ? (
